                    ...
                    <form action="<?php echo e(route('admin.permissionPage')); ?>" method="GET">
                        <div class="card-body">
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group mr-5">
                                    <label for="filter_permission_name" class="mr-2">Filter by Permission Name</label>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.editPermission', $permission->id)); ?>" class="btn btn-warning btn-sm">Edit</a>
